    ...
    override fun read(buffer: ByteBuf) {
        while (true) {
            ...
            when (opcode) {
                ...
                in 30..34 -> options[opcode - 30] = buffer.readNullTerminatedString(CHARSET).takeIf { it != "Hidden" }
                in 35..39 -> interfaceOptions[opcode - 35] = buffer.readNullTerminatedString(CHARSET)
                40 -> {
